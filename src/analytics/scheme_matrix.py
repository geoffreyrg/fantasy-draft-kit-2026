...
TEAM_SCHEME_INTEL: Dict[str, Dict[str, Any]] = {
    ...
    "DET": {
        "tree_label": "⭐ Top-10 Eco: High-Motion Zone/PA (Petzing/Campbell)",
    ...
    "CHI": {
        ...
        "is_shanahan_tree": True,
        "is_top_eco": False,
        "primary_tendency": "Elite Motion • High PROE • Creative RZ Funnel (Moore/Odunze/Burden)",
    ...
    "BUF": {
        ...
        "is_shanahan_tree": False,
        "is_top_eco": True,
        "primary_tendency": "Multi-TE 12p Power • Josh Allen Scramble Floor • Heavy GL Rush (Cook/Allen)",
